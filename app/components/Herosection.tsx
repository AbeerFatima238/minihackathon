...
export default function Herosection(){
    return(
        <div>         
            <div>
                <h1 className="flex items-center ml-96 font-serif mt-3 text-2xl text-black">Sell Your Car on PakWheels And Get the Best Price</h1>  
            </div>
            ...
            <br />
            <div>
                <h1 className=" font-serif ml-60 mt-6">FEATURED NEW CARS</h1>
